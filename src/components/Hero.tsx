  ...
  return (
    <section className="py-xl text-center relative overflow-hidden min-h-[60vh] flex items-center justify-center bg-hero bg-cover bg-center perspective-[1200px]" id="hero">
      ...
      <div className="container relative z-10 flex flex-col items-center gap-lg py-lg max-w-[800px]">
        <h1 className="text-2xl mb-md max-w-[800px] mx-auto relative translate-y-5 opacity-0 animate-fadeInUp text-white shadow-[0_4px_16px_rgba(0,0,0,0.28),0_1.5px_4px_rgba(0,0,0,0.18)]">
          I nostri case study
        </h1>
        <p className="text-base max-w-[700px] mx-auto mb-lg relative translate-y-5 opacity-0 animate-fadeInUpDelayed text-white shadow-[0_4px_16px_rgba(0,0,0,0.28),0_1.5px_4px_rgba(0,0,0,0.18)]">
