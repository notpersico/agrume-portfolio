  ...
  return (
    <footer className="bg-content-light dark:bg-[#0a0c0d] text-white py-xl pb-lg">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-lg lg:gap-16">
          <div className="lg:col-span-2">
            <h3 className="text-600 mb-md text-white">Agrume</h3>
          ...
          <div>
            <h4 className="text-500 mb-md text-white">Servizi</h4>
            <ul>
              <li className="mb-3">
          ...
          <div>
            <h4 className="text-500 mb-md text-white">Info</h4>
            <ul>
              <li className="mb-3">
        ...
        <div className="mt-lg pt-md border-t border-white/10 flex flex-col md:flex-row md:justify-between md:items-center gap-sm text-light-gray-light dark:text-light-gray-dark text-300">
...
const BackToTop: React.FC = () => {
  ...
  return (
    <a 
      href="#" 
      className={`fixed bottom-md right-md w-[50px] h-[50px] bg-primary text-white rounded-full flex items-center justify-center opacity-0 translate-y-5 transition-all duration-mid z-50 shadow-md ${visible ? 'opacity-100 translate-y-0' : ''}`}
      onClick={scrollToTop}
